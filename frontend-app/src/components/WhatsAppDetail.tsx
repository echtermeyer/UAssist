...
export function WhatsAppDetail({ message }: Props) {
    ...
    <div className="flex flex-col h-full">
            ...
            >
              ...
              <p
                className={cn(
                  ...
                  msg.sent ? "text-emerald-100/80" : "text-zinc-400"
                )}
              >
                {msg.time}
              </p>
      ...
      <div className="border-t border-zinc-100 px-4 py-3 bg-white">
        <div className="flex items-center gap-2 border border-zinc-200 rounded-xl px-3 py-2 bg-zinc-50 focus-within:bg-white focus-within:border-zinc-300 transition-all">
          ...
          />
          <button className="h-6 w-6 rounded-full bg-emerald-600 flex items-center justify-center hover:bg-emerald-700 transition-colors shrink-0">
